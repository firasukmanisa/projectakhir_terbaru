                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?= base_url('registration'); ?>">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="saldoawal" name="saldoawal" placeholder="Balance">
                                </div>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?= base_url('auth_user/login_user'); ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
